...
// ✅ CORRECCIÓN: Usa la librería 'cors' para permitir todos los orígenes
// Esto solucionará el error de CORS que ves en el frontend de Vercel.
app.use(cors({
  origin: "*"
}));
...
// ✅ Se ha agregado la ruta principal para verificar si el servidor responde
app.get('/', (_req, res) => res.status(200).send('API is running'));
app.get('/health', (_req, res) => res.status(200).send('ok'));

// ✅ Asegúrate de que todas las rutas están correctamente enrutadas
